...
public class WriteLoops {
    ...
    public int printLoopInc(int start, int stop, int step) {
    ...
    public int oneToFive() {
        return printLoopInc(1, 6, 1);
    }

    public int oneToTen() {
        return printLoopInc(1, 11, 1);
    }
    ...
    /*    for (int i = 0; i < 20; i++) {
        ...
        */
        return printLoopInc(0, 20 * printLoopInc(0, 5, 1), 1);
    }
    ...
    public int driveHome() {
        int w = 0;
        String loc = gpsCurrentLocation();
        // you need to use a .equals for two Strings.
        while (!loc.equals("Home")) {
            driveSomeMore();
            loc = gpsCurrentLocation();
            w = w + 1;
        }
    ...
    public int manageYardAndJunior() {
        ...
        sendJuniorBackToSchool("End of summer break");
            // be sure to call
            //w = w + 1;
